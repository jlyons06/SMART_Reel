...
void handle_DocumentRoot ()
{
    ...
    a_str += "<p><p> <a href=\"/worm_bait\">Worm Bait</a>\n";
...
void handle_Worm_Bait (void)
{
    ...
    String worm_page = "<!DOCTYPE html> <html> <head>\n";
    worm_page += "<meta http-equiv=\"refresh\" content=\"1; url='/'\" />\n";
    worm_page += "</head> <body> <p> <a href='/'>Back to main page</a></p>";
    worm_page += "</body> </html>";

    server.send (200, "text/html", worm_page);
}
...
void task_webserver (void* p_params)
{
    ...
    server.on ("/worm_bait", handle_Worm_Bait);
